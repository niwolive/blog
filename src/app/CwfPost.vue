<template>
  <section class="cwf-container">
    <!-- FIXME - Use a loop of post-entry components -->
    ...
    <router-link v-for="post in postList" :to="post.route">post.title</router-link>
  </section>
</template>
...
<script>
  ...
  export default {
    ...
    components: {
     PostEntry,
     // Posts remove a post in the list below to unpublish it
     post1,
     post2
    }
  }
